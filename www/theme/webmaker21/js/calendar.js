...
function calendar_draw(set_date)
{
    ...
    var html = "<table border=\"0\" width=\"200\">";
    ...
    // 요일표시 html
    html += "<tr height=\"20\">";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">일</td>";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">월</td>";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">화</td>";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">수</td>";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">목</td>";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">금</td>";
    html += "<td width=14% style=\"background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">토</td>";
    html += "</tr>";
