            ...
            <ul id="sit_opt_added">
                <li class="sit_opt_list">
                    ...
                    <div>
                        ...
                        <button type="button" class="sit_qty_plus btn_frmline" data-btntype="plus"><i class="fa fa-plus"></i></button>
                        <button type="button" class="sit_qty_minus btn_frmline" data-btntype="minus"><i class="fa fa-minus"></i></button>
                    </div>
                </li>
            </ul>
            <script>
